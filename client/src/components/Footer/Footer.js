    ...
    <div className="footer">
      <div className="terrinary">
        ...
        <div className="terrinary-menu-container-wrap">
          ...
          <p>Social</p>
            <ul className="menu-wrapper">
              <li className = "menu-item"><Link to="http://www.twitter.com/meetup"><i class="fab fa-twitter" ></i> Twitter</Link></li>
              <li className = "menu-item"><Link to="http://www.facebook.com/meetup"><i class="fab fa-facebook-square" ></i> Facebook</Link></li>
              <li className = "menu-item"><Link to="http://www.dribble.com"><i class="far fa-basketball-ball"></i> Dribble</Link></li>
            </ul>
          </div>
        </div>
      </div>
